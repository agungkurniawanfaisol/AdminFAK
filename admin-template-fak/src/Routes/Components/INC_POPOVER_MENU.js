...
const INC_POPOVER_MENU = (props) => {
    const { StateValue } = props;
    const { VAL_TOGGLE_OPEN_MENU } = StateValue;

    if (!VAL_TOGGLE_OPEN_MENU) {
        return <div />
    }
    return (
        <div>
            <div className='w-full absolute bg-white rounded-b-md dark:bg-gray-900 md:hidden lg:hidden'>
...
export default INC_POPOVER_MENU